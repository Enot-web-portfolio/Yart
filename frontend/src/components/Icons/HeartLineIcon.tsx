...
const HeartLineIconComponent: FC<IconProps> = (props: IconProps) =>
  <svg width={props.size} height={props.size} viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000" {...props}>
    <path
    ...
    <path d="M14.5 5L15 6L15.5 5" strokeWidth="0.6"/>
  </svg>;

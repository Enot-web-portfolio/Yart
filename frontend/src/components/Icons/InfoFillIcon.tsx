...
const InfoFillIconComponent: FC<IconProps> = (props: IconProps) =>
  <svg width={props.size} height={props.size} viewBox="0 0 28 28" fill="#000" stroke="#000" xmlns="http://www.w3.org/2000/svg" {...props}>
    <circle cx="14" cy="14" r="13.5"/>
    <path d="M14 20V12" stroke="white" strokeWidth="2"/>

...
const CategorySelectComponent: FC<Props> = (props: Props) => {
  // Категории
  ...
  return (<div className={'category_select'}>
    {categories.map((category, i) =>
      <div className={`category_select__item ${category.checked ? 'checked' : ''}`}
        key={i}
        onClick={() => onToggle(category.id)}
        style={{ backgroundColor: category.checked ? category.backgroundColor : undefined }}>
        <Text className={'category_select__item_name'}
